...
import { AbstractControl, ControlValueAccessor, FormGroupDirective, NgControl, NgForm, NG_VALUE_ACCESSOR, Validators } from '@angular/forms';
...
export class PasswordInputComponent implements ControlValueAccessor, ErrorStateMatcher {
  ...
  onVisibilityClick($event: MouseEvent): void {
    if (this._visible) {
